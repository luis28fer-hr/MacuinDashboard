...
<body>
    ...
    <header>
        <h2>Macuin Dashboard | Tickets Por Estatus </h2>
    </header>
        ...
        @foreach ($consultaTickets as $ticket)
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <th style="color: #0e2b46; font-weight: 900; text-decoration: underline" scope="row" colspan="2">Estatus: {{ $ticket->estatus }}</th>
