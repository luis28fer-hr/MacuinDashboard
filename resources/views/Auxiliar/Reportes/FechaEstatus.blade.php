...
<body>
    ...
    <header>
        <h2>Macuin Dashboard | Tickets Por Estatus y Fecha</h2>
    </header>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $ticket->cliente->departamento->nombre }} </td>
                    </tr>
                    ...
                    <tr>
                        <th scope="row" style="color: #0e2b46; font-weight: 900; text-decoration: underline" colspan="2">Estatus: {{ $ticket->estatus }}</th>
                        <th scope="row" style="color: #0e2b46; font-weight: 900; text-decoration: underline">Fecha: {{ $ticket->created_at }}</th>
                    </tr>
                </tbody>
            </table>
            <table class="table">
